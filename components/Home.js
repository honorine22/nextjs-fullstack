            ...
            <div className='grid grid-cols-1 lg:grid-cols-4 gap-y-16 gap-x-8'>
                {elements.map((value, index) => {
                    return <div key={index}>
                        <div className="max-w-sm bg-white rounded-lg border dark:border-gray-600 border-gray-200 shadow-md dark:bg-gray-800">
                            <a href="#">
                            ...
                            <div className="p-5">
                                ...
                                <h5 className="mb-2 text-xl font-bold text-black dark:text-white">$12
                                    <span className='text-gray-600 dark:text-white'> / night</span>
                                </h5>
                                <div className='flex justify-between items-center'>
                                    ...
                                    <span className="text-md text-gray-600 dark:text-white">(5 Reviews)</span>
                                </div>
