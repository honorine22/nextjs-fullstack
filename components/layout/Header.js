...
export const Header = () => {
    return (
        <nav className="bg-white border-b-2 shadow-lg sticky top-0 z-50 dark:border-gray-600 border-gray-200 px-2 sm:px-4 rounded dark:bg-gray-800">
            <div className="container flex flex-wrap justify-around items-center mx-auto">
                <a href="#" className="flex">
                    ...
                    <span className="self-center text-blue-700 text-4xl font-semibold whitespace-nowrap">BookIt</span>
                </a>
